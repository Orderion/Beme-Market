...
function IconSun() {
  return (
    <svg viewBox="0 0 24 24" className="hdr-svg" aria-hidden="true">
      <path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12z" fill="none" stroke="currentColor" strokeWidth="1.7" />
...
export default function Header({ onMenu, onCart }) {
  ...
  return (
    <header className="hdr">
      ...
      <button className="hdr-brand" onClick={() => navigate("/shop")} aria-label="Go to shop">
        Beme Market
      </button>
      ...
      <div className="hdr-right">
        ...
        <button className="hdr-icon hdr-bag" onClick={onCart} aria-label="Open cart">
          <IconBag />
