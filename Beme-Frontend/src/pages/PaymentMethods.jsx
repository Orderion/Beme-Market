...
/*
  Props / context you'll need to wire up:
  - hasCompletedOrder: boolean — true once customer has at least 1 delivered order
  - Pass this from your orders context or Firestore
*/
      ...
      <div className="sp-body sp-body--flush">
        ...
        <div className="pm-card">
          ...
          <div className="pm-badges">
            <span className="pm-badge pm-badge--green">
              <svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              SSL Secured
            </span>
            <span className="pm-badge pm-badge--green">
              <svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
        ...
        <div className={`pm-card ${!hasCompletedOrder ? 'pm-card--disabled' : ''}`}>
            ...
            <div style={{ flex: 1 }}>
              ...
              {!hasCompletedOrder && (
                <span className="pm-badge pm-badge--warn">
                  <svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" strokeWidth="2.2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
          ...
          {hasCompletedOrder ? (
            ...
            <p className="pm-card__desc pm-card__desc--muted">
