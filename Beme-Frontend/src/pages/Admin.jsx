...
useEffect(() => {
const hasOpenModal = editModalOpen || deleteModalOpen || bulkDeleteModalOpen;
...
}, [editModalOpen, deleteModalOpen, bulkDeleteModalOpen]);
...
>
<div className="admin-modal-head admin-modal-head--fullscreen">
